                            ...
                            <table id="userTable" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $contact['loan'] == 1 ? 'Yes' : 'No' }}</td>
                                        <td>
                                        <button class="btn btn-primary btn-sm" onclick="viewPost({{ $contact['id'] }})">View</button>

                                            <button class="btn btn-danger btn-sm"
                                                onclick="deletePost({{ $contact['id'] }})">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
