...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <div class="alert alert-success">
        PostApproval created successfully.
        <br>
        Post Title: {{ $postApproval->title }}
    </div>
    @endif
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('postcreate') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" id="user_id" name="user_id"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="sale_status">Sale Status</label>
                                            <select class="form-select" id="sale_status" name="sale_status" required>
                                                <option value="">Select Sale Status</option>
                                                <option value="sale_status1">Sale Status 1</option>
                                                <option value="sale_status2">Sale Status 2</option>
                                                <!-- Add more options as needed -->
                                            </select>
                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Please select Sale Status.</div>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="plot_area">Plot Area</label>
                                            <input type="text" id="plot_area" name="plot_area" class="form-control"
                                                placeholder="Plot Area" required />
                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Please enter Plot Area.</div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="no_of_open_sides" name="no_of_open_sides"
                                                class="form-control" placeholder="No. of Open Sides" required />
                                            <div class="valid-feedback">Looks good!</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="width_of_road_facing_property"
                                                ...
                                                placeholder="Width of Road Facing Property" required />
                                            <div class="valid-feedback">Looks good!</div>
