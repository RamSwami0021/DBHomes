...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card p-5">
                                ...
                                <form class="needs-validation" novalidate method="POST"
                                        action="{{ route('admin.location.submit') }}">
                                    @csrf
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Location Name</label>
                                            <input type="text" id="basic-addon-name" class="form-control"
                                                placeholder="Location Name" aria-label="Name"
                                                name="location" aria-describedby="basic-addon-name"
                                                value="" required />
    ...
    if (confirm('Are you sure you want to delete this post?')) {
        ...
        $.ajax({
            url: '/admin/location/delete/' + userId,
            type: 'get',
