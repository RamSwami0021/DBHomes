                        ...
                        <div class="col-md-12 col-12">
                            <div class="card p-5">
                                ...
                                <form class="needs-validation" novalidate method="POST"
                                        action="{{ route('admin.enquiry.update', ['id' => $enquiry['id']]) }}">
                                    @csrf
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Name</label>
                                            <input type="text" id="basic-addon-name" class="form-control"
                                                placeholder="Name" aria-label="Name"
                                                name="name" aria-describedby="basic-addon-name"
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input type="text" 
                                            name="contact_no" id="basic-addon-name" class="form-control"
                                                placeholder="Contact Number" aria-label="Name"
                                                aria-describedby="basic-addon-name" value="{{ $enquiry['contact_no'] }}"
                                                required />
                                            <div class="valid-feedback">Looks good!</div>
