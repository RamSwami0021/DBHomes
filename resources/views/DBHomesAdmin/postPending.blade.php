...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button class="btn btn-primary btn-sm"
                                                ...
                                                onclick="approvedPost({{ $post->id }})">Approved</button>
    ...
    function viewPost(postId) {
        window.location.href = '/admin/postPending/edit/' + postId;
    }
    ...
    if (confirm('Are you sure you want to delete this post?')) {
        ...
        $.ajax({
            url: '/admin/postPending/delete/' + userId,
            type: 'get',
    ...
    function approvedPost(postId) {
        if (confirm('Are you sure you want to approve this post?')) {
            ...
            $.ajax({
                url: '/admin/approvedPost/' + postId,
                type: 'get',
                data: { _token: '{{ csrf_token() }}' },
                success: function(response) {
                    // Handle success
                    alert('Post approved and moved to posts table');
                    // Optionally, update the UI to reflect the approval
                    location.reload(); // Refresh the page to update the UI
                },
                error: function(xhr) {
                    // Handle error
                    alert('Error approving post: ' + xhr.responseText);
                }
            });
        }
    }
