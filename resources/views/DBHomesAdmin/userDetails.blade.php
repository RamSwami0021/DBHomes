                        ...
                        <div class="col-md-12 col-12">
                            <div class="card p-5">
                                ...
                                <form class="needs-validation" novalidate method="POST"
                                        ...
                                        <!-- @method('POST') -->
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">User Id</label>
                                            <input readonly type="text" name="id" id="basic-addon-name" class="form-control"
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input type="email" name="email" id="basic-default-email1"
                                                ...
                                                aria-label="john.doe@email.com" value="{{ $user['email'] }}"
                                                required />
                                            <div class="valid-feedback">Looks good!</div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="password" id="basic-addon-name"
                                                class="form-control" placeholder="Password" aria-label="Name"
                                                aria-describedby="basic-addon-name" value="{{ $user['password'] }}"
                                                required />
                                            <div class="valid-feedback">Looks good!</div>
